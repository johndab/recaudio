...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<?php if ( current_user_can( 'customize' ) ) { ?>
			<div class="feature-section one-col cta">
				<div class="col">
					<a class="button button-primary button-hero load-customize hide-if-no-customize" href="<?php echo esc_url( admin_url( 'customize.php?theme=recaudio' ) ); ?>"><?php _e( 'Give Twenty Nineteen a try' ); ?></a>
				</div>
			</div>
		<?php } ?>
